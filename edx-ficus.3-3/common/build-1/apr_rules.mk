...
#
apr_builddir=/opt/lms_edx/edx-ficus.3-3/common/build-1
apr_builders=/opt/lms_edx/edx-ficus.3-3/common/build-1
top_builddir=/opt/lms_edx/edx-ficus.3-3/common/build-1
...
CPPFLAGS=-DAI_ADDRCONFIG=0 -I/bitnami/megastack-linux-x64/output/sqlite/include -I/opt/lms_edx/edx-ficus.3-3/common/include  -I/opt/lms_edx/edx-ficus.3-3/common/include/sasl -I/opt/lms_edx/edx-ficus.3-3/common/include
LDFLAGS=-L/opt/lms_edx/edx-ficus.3-3/common/lib -L/opt/lms_edx/edx-ficus.3-3/common/lib -L/bitnami/megastack-linux-x64/output/sqlite/lib -L/opt/lms_edx/edx-ficus.3-3/python/lib -L/opt/lms_edx/edx-ficus.3-3/common/lib -L/bitnami/megastack-linux-x64/output/ImageMagick/lib -L/bitnami/megastack-linux-x64/output/ImageMagick/lib -ldl
LIBS=
DEFS=-DHAVE_CONFIG_H
