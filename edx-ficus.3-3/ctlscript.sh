...
INSTALLDIR=/opt/lms_edx/edx-ficus.3-3
...
#xqueue_code_start
XQUEUE_SCRIPT=/opt/lms_edx/edx-ficus.3-3/apps/xqueue/scripts/ctl-xqueue-consumer.sh
#xqueue_code_end
#forum_code_start
FORUM_SCRIPT=/opt/lms_edx/edx-ficus.3-3/apps/forum/scripts/ctl.sh
#forum_code_end
#edx_code_start
EDX_SCRIPT=/opt/lms_edx/edx-ficus.3-3/apps/edx/scripts/ctl-edx-celery-workers.sh
#edx_code_end
